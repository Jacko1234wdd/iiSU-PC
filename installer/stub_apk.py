...
def _manifest_xml(package_name: str, app_label: str) -> str:
    ...
    return (
        ...
        # its list from a PackageManager query that should match this
        # manifest regardless (confirmed by decompiling iiSU: plain
        # ACTION_MAIN + CATEGORY_LAUNCHER, MATCH_ALL, no stricter category
        # or icon requirement found), but a real icon removes the one
        # concrete way this stub still looks different from a normal app.
